...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('PO-Notes','poNotes','table','poNotes','cols=2;colTitles=["noteType","Note"];colWidth=["15","30"];',21,'AEV','PO','String','PO-tabNote');
