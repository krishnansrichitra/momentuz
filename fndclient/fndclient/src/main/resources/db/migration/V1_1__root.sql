...
insert into filter_field(id,list_metadata_id,field_key,control,accessor,seq_no) values('PO-DOCNO','PO','docNo','text','docNo',1);
...
insert into list_columns(id,list_metadata_id,field_key,accessor,seq_no) values ('PO-DOCNO','PO','docNo','docNo',1);
insert into list_columns(id,list_metadata_id,field_key,accessor,seq_no) values ('PO-SUPNAME','PO','supplierName','supplierName',2);
...
insert into list_columns(id,list_metadata_id,field_key,accessor,seq_no) values ('PO-STATUS','PO','poStatus','status["fvDescription"]',5);