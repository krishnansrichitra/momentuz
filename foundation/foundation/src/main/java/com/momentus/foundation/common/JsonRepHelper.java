...
public class JsonRepHelper {
                ...
                if (List.class.isAssignableFrom(fieldType)) {
                    ...
                    if (type instanceof ParameterizedType parameterizedType) {
                        ...
                        if (BaseEntity.class.isAssignableFrom( cls)) {
                            Map<String,Object> childMap = getFullMapRepresentation((BaseEntity) cls.newInstance());
    ...
    public static <T extends BaseEntity>  Map<String,Object> getMapRepresentationWithKeys(T entity,Boolean subObject)
    {
        ObjectMapper mapper = new ObjectMapper();
        mapper.registerModule(new JavaTimeModule());
        Map<String,Object> map = mapper.convertValue(entity,new TypeReference<Map<String, Object>>() {});
                    ...
                    if (subObject == true) {
                        ...
                        if (BaseEntity.class.isAssignableFrom(fieldType)) {
                            ...
                            if (type instanceof ParameterizedType parameterizedType) {
                                ...
                                Class<?> cls = (Class<?>) actualType;
                                if (BaseEntity.class.isAssignableFrom(cls)) {
                                    Map<String, Object> childMap = getMapRepresentationWithKeys((BaseEntity) cls.newInstance(), false);
                                    childList.add(childMap);
                                }
