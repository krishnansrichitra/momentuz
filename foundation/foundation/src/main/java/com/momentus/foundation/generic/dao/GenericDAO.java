...
public class GenericDAO {
  ...
  public <T extends BaseEntity> long getCountForList(
      Map<String, Object> filter, Class<T> entityClass) {
  ...
  public <T extends BaseEntity> List<T> listByFilter(
      Map<String, Object> filter, Class<T> entityClass, int offset, int limit) {
  ...
  public <T extends BaseEntity, R> List<R> listFieldByFilter(
    ...
    cq.select(typedFieldPath).where(cb.and(predicates.toArray(new Predicate[0])));
