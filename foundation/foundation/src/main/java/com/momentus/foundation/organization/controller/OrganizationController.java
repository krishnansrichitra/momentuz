...
public class OrganizationController {
  ...
  public ResponseEntity<Map<String, Object>> create(
    ...
    ApplicationContext applicationContext =
        applicationContextHelper.generateAppContext(authentication);
    Organization organization = JsonRepHelper.getEntityFromMap(request, Organization.class);
    TransactionResponse transactionResponse =
        organizationService.saveOrganization(organization, applicationContext);
  ...
  public ResponseEntity<Map<String, Object>> getByOrgCode(
      @RequestParam String orgCode, Authentication authentication) {
