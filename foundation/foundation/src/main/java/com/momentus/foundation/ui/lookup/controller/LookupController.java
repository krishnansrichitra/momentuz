...
public class LookupController {
  ...
  public ResponseEntity<Map<String, String>> getFiniteValueDropdowns(
      @RequestParam String fvGroup, Authentication authentication) {
  ...
  public ResponseEntity<List<String>> getTypeAheadValues(
      @RequestParam String entity, String field, String value, Authentication authentication) {
