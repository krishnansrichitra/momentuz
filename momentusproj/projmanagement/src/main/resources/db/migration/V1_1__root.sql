...
insert into entity (entity_name,entity_display,full_package,profile_group_code,created_by,created_time,support_import)
values ('Release','Release','com.momentus.projmanagement.releases.model.Release', 'GNL','seed',now(),1);

insert into entity (entity_name,entity_display,full_package,profile_group_code,created_by,created_time,support_import)
values ('Team','Team','com.momentus.projmanagement.releases.model.Team', 'GNL','seed',now(),1);
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-CRD-RLSID','id','dropdown','Release','Release',2,'EV','RLSCR-IT','Numeric','RLSCR-IT-CRD');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent,style) values ('RLSCR-IT-CRD-FT','','button','Fetch','fetch',3,'EV','RLSCR-IT','String','RLSCR-IT-CRD','btn btn-warning');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-CRD-BLN1','','blank',null,null,4,'EV','RLSCR-IT','','RLSCR-IT-CRD');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-CRD-BLN2','','blank',null,null,5,'EV','RLSCR-IT','','RLSCR-IT-CRD');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-CRD-PRJ','project.id','dropdown','Project','Project',6,'E','RLSCR-IT','Numeric','RLSCR-IT-CRD');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-CRD-RLSNO','releaseNo','text','Release No',null,7,'E','RLSCR-IT','String','RLSCR-IT-CRD');
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-TM-PRDOWN','productOwner.userId','lookup','Product Owner','User',16,'EV','RLSCR-IT','String','RLSCR-IT-TM');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('RLSCR-IT-TM-SCRM','scrumMaster.userId','lookup','Scrum Master','User',17,'EV','RLSCR-IT','String','RLSCR-IT-TM');
...
insert into finite_group(group_code,group_name) values ('rls_status','Release Status') on duplicate key update group_name = group_name;
...
values ('WI-IT','IT','WorkItem','nxtup_comp1','nxtup_seq') on duplicate key update id = id;
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-PRJ','projectId','dropdown','Project','Project',1,'AE','WTMN-IT','Numeric');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-TSK','type.fvCode','dropdown','Type','fv::wi_type',2,'AE','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-RLS','releaseId','dropdown','Release','Release',3,'AE','WTMN-IT','Numeric');
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-ID','id','hidden','Id',null,4,'AEV','WTMN-IT','Numeric');
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-NO','wiNo','text','Workitem No',null,5,'EV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-TFROW','','fullrow','',null,6,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('WTMN-IT-TIT','summary','textArea','Summary','rows=1;cols=100;',7,'AEV','WTMN-IT','String','WTMN-IT-TFROW');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-STATS','status.fvDescription','span','Status',null,8,'EV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-DSROW','','fullrow','',null,9,'AEV','WTMN-IT','String');
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-PRNT','parent','lookup','Parent','WorkItem',15,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-DEP','dependentOn','lookup','Dependent On','WorkItem',16,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-BLCK','blockedBy','lookup','Blocked By','WorkItem',17,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-DUP','duplicateOf','lookup','Duplicate Of','WorkItem',18,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-RSCD','reasonCode.fvCode','dropdown','Reason Code','fv::wi_inv_reason',19,'AE','WTMN-IT','String');


insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-TMUM','timeUOM.fvCode','dropdown','Time UOM','fv::wi_time_uom',20,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-EST','estimate','text','Estimated Effort',null,21,'AEV','WTMN-IT','Numeric');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-PLNSD','plannedStartDate','date','Planned Start Date',null,22,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-ACCCRTROW','','fullrow','',null,23,'AEV','WTMN-IT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('WTMN-IT-ACCCRT','acceptanceCriteria','textarea','Acceptance Criteria','rows=5;cols=100;',24,'AEV','WTMN-IT','String','WTMN-IT-ACCCRTROW');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('WTMN-IT-LBL','label','textarea','Labels','rows=2;cols=100;',55,'AEV','WTMN-IT','String');
...
insert into updateview_buttons(id,button_class,inner_text,js_method,seq_no,visibility,updateview_metadata_id) values ('WTMN-IT-SAVE','btn btn-primary','Save','onWTSave',1,'AE','WTMN-IT');
insert into updateview_buttons(id,button_class,inner_text,js_method,seq_no,visibility,updateview_metadata_id) values ('WTMN-IT-EDT','btn btn-info','Edit','onWTEdit',2,'V','WTMN-IT');
...
insert into finite_group(group_code,group_name) values ('sow_type','SOW Type') on duplicate key update group_name = group_name;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_pgm','Program Management','sow_type','IT',1)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_dev','Development','sow_type','IT',2)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_test','Testing','sow_type','IT',3)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_aut','Automation','sow_type','IT',4)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_mnpsply','Manpower Supply','sow_type','IT',5)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('sow_type_others','Others','sow_type','IT',6)  on duplicate key update fv_code = fv_code;

insert into finite_group(group_code,group_name) values ('mlst','Milestone') on duplicate key update group_name = group_name;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('mlst_schd','Scheduled','mlst','ROOT',1)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('mlst_achtme','Achieved on time','mlst','ROOT',2)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('mlst_resch','Reschedluded','mlst','ROOT',3)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('mlst_dlyd','Delayed','mlst','ROOT',4)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('mlst_dlydcom','Completed after delay','mlst','ROOT',5)  on duplicate key update fv_code = fv_code;


insert into finite_group(group_code,group_name) values ('wi_type','Work Item Type') on duplicate key update group_name = group_name;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('wi_type_epc','Epic','wi_type','IT',10)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_fsw','Functional Spec Writing','wi_type','IT',20) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_us','User Story','wi_type','IT',30) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_def','Defect','wi_type','IT',40) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_aut','Automation Task','wi_type','IT',50) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_dvt','Development Task','wi_type','IT',60) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_tc','Testing Task','wi_type','IT',70) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_dt','Documentation Task','wi_type','IT',80) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_ms','Miscellaneous Task','wi_type','IT',90) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_type_fr','Feature Request','wi_type','IT',100) on duplicate key update fv_code = fv_code;


insert into finite_group(group_code,group_name) values ('wi_status','Work Item Status') on duplicate key update group_name = group_name;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no) values ('wi_status_new','New','wi_status','IT',10)  on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_assn','Assigned','wi_status','IT',20) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_inpg','In Progress','wi_status','IT',30) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_dvc','Dev Complete','wi_status','IT',40) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_rdt','Ready for Test','wi_status','IT',50) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_tip','Testing In Progress','wi_status','IT',60) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_tcp','Testing Complete','wi_status','IT',70) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_dc','Documentation Complete','wi_status','IT',80) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_rut','Ready for UAT','wi_status','IT',90) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_utp','UAT In Progress','wi_status','IT',100) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_utc','UAT Complete','wi_status','IT',110) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_tsc','Task Complete','wi_status','IT',120) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_tsv','Task Validated','wi_status','IT',130) on duplicate key update fv_code = fv_code;
...
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_dfr','Deferred','wi_status','IT',180) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_apr','Approved','wi_status','IT',190) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_dup','Duplicate','wi_status','IT',200) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_status_inv','Invalid','wi_status','IT',210) on duplicate key update fv_code = fv_code;
...
insert into finite_group(group_code,group_name) values ('wi_inv_reason','Invalid Reason Code') on duplicate key update group_name = group_name;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_inv_reason_dup','Duplicate','wi_inv_reason','IT',10) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_inv_reason_asd','As Designed','wi_inv_reason','IT',20) on duplicate key update fv_code = fv_code;
insert into finite_value(fv_code,fv_value,group_code,profile_code,seq_no)values ('wi_inv_reason_cnrp','Cannot Reproduce','wi_inv_reason','IT',30) on duplicate key update fv_code = fv_code;

-- wi_task_status_mapping  ---


create table wi_task_status_mapping (
        id bigint primary key auto_increment,
        wi_type varchar(255),
        wi_status varchar(255),
        seq  FLOAT(15),
        ...
        foreign key (wi_status) references finite_value (fv_code),
        foreign key (wi_type) references finite_value (fv_code),
        foreign key (profile_code) references profile (profile_code)
    );


    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_new','IT',1);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_assn','IT',2);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_inpg','IT',3);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_apr','IT',4);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_cls','IT',5);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_dfr','IT',6);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fr','wi_status_inv','IT',7);



      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_new','IT',1);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_assn','IT',2);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_inpg','IT',3);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_tsc','IT',4);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_tsv','IT',5);
      ...
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_dup','IT',10);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_dfr','IT',11);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_ms','wi_status_inv','IT',12);



   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_new','IT',1);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_assn','IT',2);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_inpg','IT',3);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_dc','IT',3);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_tsv','IT',5);
   ...
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_dup','IT',10);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_dfr','IT',11);
   insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_fsw','wi_status_inv','IT',12);
      ...
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dt','wi_status_inpg','IT',3);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dt','wi_status_dc','IT',3);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dt','wi_status_tsv','IT',5);
      ...
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dt','wi_status_dfr','IT',10);
      insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dt','wi_status_inv','IT',11);





    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_tc','wi_status_rdt','IT',1);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_tc','wi_status_tip','IT',2);
    ...
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_tc','wi_status_dfr','IT',8);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_tc','wi_status_inv','IT',9);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dvt','wi_status_inpg','IT',3);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dvt','wi_status_tsc','IT',4);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dvt','wi_status_dfr','IT',9);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_dvt','wi_status_inv','IT',10);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_aut','wi_status_inpg','IT',3);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_aut','wi_status_tsc','IT',4);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_aut','wi_status_tsv','IT',5);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_aut','wi_status_dfr','IT',10);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_aut','wi_status_inv','IT',11);
 ...
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_inpg','IT',3);
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_dvc','IT',4);
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_rut','IT',5);
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_utp','IT',6);
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_utc','IT',7);
 ...
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_dfr','IT',12);
 insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_epc','wi_status_inv','IT',13);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_inpg','IT',3);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_dvc','IT',4);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_rdt','IT',5);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_tip','IT',6);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_tcp','IT',7);
  ...
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_dfr','IT',12);
  insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_us','wi_status_inv','IT',13);



    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_new','IT',1);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_assn','IT',2);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_inpg','IT',3);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_dvc','IT',4);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_rdt','IT',5);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_tip','IT',6);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_tcp','IT',7);
    ...
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_dfr','IT',12);
    insert into wi_task_status_mapping (wi_type,wi_status,profile_code,seq) values ('wi_type_def','wi_status_inv','IT',13);




-- wi_task_status_mapping end --
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('PRJT-tabset','','tabset','',null,12,'AEV','PRJT','String');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('PRJT-tabsow','','tabset','SOW',null,14,'AEV','PRJT','List','PRJT-tabset');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('PRJT-tabmiles','','tabset','Milestones',null,15,'AEV','PRJT','List','PRJT-tabset');
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type,parent) values ('PRJT-tabSupInfo','','tabset','Summary',null,13,'AEV','PRJT','Set','PRJT-tabset');
...
insert into updateview_fields(id,accessor,control,field_key,param,seq_no,visibility,updateview_metadata_id,data_type) values ('RLCR-HR1','','hr','',null,4.1,'AEV','RLCR','');
